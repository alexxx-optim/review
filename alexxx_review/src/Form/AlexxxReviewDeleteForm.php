...
/**
 * @file
 * Contains \Drupal\alexxx_review\Form\TermDeleteForm.
 */
 ...
 */
class AlexxxReviewDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.alexxx_review.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('alexxx_review')->notice('deleted %title.', [
